...
public class BackgroundLoader extends Service {
	...
	public void onStart(Intent intent, int startId) {
		...
		DatabaseHelper dbHelper = DatabaseHelper.initOrSingleton(this);
		ApplicationInfoManager applicationInfoManager = ApplicationInfoManager.singleton(getPackageManager());
